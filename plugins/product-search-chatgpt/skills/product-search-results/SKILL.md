...
When the request asks for a specific count, show exactly that many cards unless fewer valid products exist. State clearly when no product matches or when a product is excluded because it is out of stock.
